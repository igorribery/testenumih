Este é um projeto que utiliza React e Vite para desenvolvimento de uma aplicação web. É necessário ter o Node.js instalado em sua máquina para poder rodar o projeto.
